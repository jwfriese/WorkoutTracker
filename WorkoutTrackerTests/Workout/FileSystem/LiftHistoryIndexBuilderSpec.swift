    ...
    override func spec() {
        describe("LiftHistoryIndexBuilder") {
            ...
            describe("When building an index of histories for lifts") {
                ...
                beforeEach {
                    let liftOneWorkoutOne = Lift(withName: "lift one")
                    let liftTwoWorkoutOne = Lift(withName: "lift two")
                    let liftThreeWorkoutOne = Lift(withName: "lift three")
                    let liftFourWorkoutOne = Lift(withName: "lift four")
                    let liftFiveWorkoutOne = Lift(withName: "lift five")
                    let liftSixWorkoutOne = Lift(withName: "lift six")
                    ...
                    let liftOneWorkoutTwo = Lift(withName: "lift one")
                    let liftThreeWorkoutTwo = Lift(withName: "lift three")
                    let liftFiveWorkoutTwo = Lift(withName: "lift five")
                    ...
                    let liftTwoWorkoutThree = Lift(withName: "lift two")
                    let liftFourWorkoutThree = Lift(withName: "lift four")
                    let liftSixWorkoutThree = Lift(withName: "lift six")
