    ...
    override func spec() {
        ...
        describe("StartupViewController") {
            ...
            beforeEach {
                ...
                try! storyboard.bindViewController(mockWorkoutListViewController, asInitialViewControllerForReferencedStoryboardWithName: "WorkoutList")
            ...
            describe("After its view has loaded") {
                ...
                describe("When the migration agent finishes its work") {
                    ...
                    it("should replace the window's root view controller with the workout list page") {
                        expect(UIApplication.sharedApplication().keyWindow?.rootViewController).to(beIdenticalTo(mockWorkoutListViewController))
                    }
                }
            }
        }
